...
CREATE TABLE "Review" (
    ...
    "mintiness" INTEGER NOT NULL,
    "tasteScore" INTEGER,
    "chocoRichness" INTEGER,
...
CREATE TABLE "Chocolate" (
    ...
    "categoryId" INTEGER,
    "description" TEXT,
    "cacaoPercent" DECIMAL(5,2),
    "hasMint" BOOLEAN NOT NULL DEFAULT true,
...
-- CreateIndex
CREATE UNIQUE INDEX "Chocolate_brandId_name_key" ON "Chocolate"("brandId", "name");
